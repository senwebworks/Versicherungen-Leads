...
const standardTrustBadges = `<div class="trust-badge"><svg width="18" height="18" viewBox="0 0 24 24" fill="var(--success)"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg> 100% Kostenlos</div><div class="trust-badge">🔒 SSL-Sicher</div><div class="trust-badge">🏆 TÜV-Geprüft</div><div class="trust-badge">🤝 Unabhängig</div><div class="trust-badge">⚡ 280+ Anbieter</div>`;
